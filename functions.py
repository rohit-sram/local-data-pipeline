...
def get_video_idx():
    ...
    while page_token != 0:
        ...
        video_record_list += get_video_records(response)
...
def extract_transcript_text(transcript: list) -> str:
    """
...
def handle_special_chars(df: pl.dataframe.frame.DataFrame) -> pl.dataframe.frame.DataFrame:
    """
...
def set_datatypes(df: pl.dataframe.frame.DataFrame) -> pl.dataframe.frame.DataFrame:
    """
